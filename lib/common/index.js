...
var getSelectIndex = exports.getSelectIndex = function getSelectIndex(_ref12) {
  var index = _ref12.index,
    _ref12$defaultIndex = _ref12.defaultIndex,
    defaultIndex = _ref12$defaultIndex === void 0 ? 0 : _ref12$defaultIndex;
  return !isNaN(index) ? Number(index) : Number(defaultIndex);
};