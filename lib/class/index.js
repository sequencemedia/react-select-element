...
var SelectElement = exports.default = /*#__PURE__*/function (_Component) {
  ...
  function SelectElement(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleActiveEnterFocus", function () {
      return true;
    });
    _defineProperty(_assertThisInitialized(_this), "handleActiveEnterBlur", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleOptionClick", function (index) {
      _this.setState({
        hasActiveOptions: false
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleActiveOptionsKeyPress", function (event) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleActiveOptionsKeyUp", function (event) {
      return _this.handleActiveOptionsKeyCode(event);
    });
    _defineProperty(_assertThisInitialized(_this), "handleActiveOptionsKeyDown", function () {
      return true;
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "getOptionRef", function (index) {
      var activeIndex = _this.state.activeIndex;
      if (index === activeIndex) {
        return _this.activeOption;
      }
    });
    _defineProperty(_assertThisInitialized(_this), "renderOptionDisabled", function (option, index) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderOptionReadOnly", function (option, index) {
      var optionText = _this.renderOptionText(option, index);
      var selectIndex = _this.state.selectIndex;
      return /*#__PURE__*/_react.default.createElement("li", {
        key: index,
