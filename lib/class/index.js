...
var SelectElement = exports.default = /*#__PURE__*/function (_Component) {
  function SelectElement(props) {
    ...
    _defineProperty(_this, "handleActiveOptionsKeyPress", function (event) {
      ...
      _this.handleActiveOptionsKeyChar(event);
    });
    ...
    var id = props.id;
    _this.state = {
      id: id !== null && id !== void 0 ? id : (0, _nanoid.nanoid)(),
  ...
  return _createClass(SelectElement, [{
    ...
    value: function getOptionsFirstChild() {
      var _this$getOptions$firs;
      return (_this$getOptions$firs = this.getOptions().firstChild) !== null && _this$getOptions$firs !== void 0 ? _this$getOptions$firs : null;
    }
  }, {
    key: "getOptionsLastChild",
    value: function getOptionsLastChild() {
      var _this$getOptions$last;
      return (_this$getOptions$last = this.getOptions().lastChild) !== null && _this$getOptions$last !== void 0 ? _this$getOptions$last : null;
    }
  }, {
    key: "getActiveOptionPreviousSibling",
    value: function getActiveOptionPreviousSibling() {
      var _this$getActiveOption;
      return (_this$getActiveOption = this.getActiveOption().previousSibling) !== null && _this$getActiveOption !== void 0 ? _this$getActiveOption : null;
    }
  }, {
    key: "getActiveOptionNextSibling",
    value: function getActiveOptionNextSibling() {
      var _this$getActiveOption2;
      return (_this$getActiveOption2 = this.getActiveOption().nextSibling) !== null && _this$getActiveOption2 !== void 0 ? _this$getActiveOption2 : null;
    }
  }, {
    ...
    value: function getSelectedOptionReadOnlyClassName() {
      return 'selected-option';
    }
  }, {
    ...
    value: function shouldComponentUpdate(props, state) {
      ...
      return state.hasActiveOptions !== this.state.hasActiveOptions || state.activeEnter !== this.state.activeEnter || state.activeIndex !== this.state.activeIndex || state.selectIndex !== this.state.selectIndex;
    }
  }, {
    ...
    value: function renderSelectedOptionDisabled() {
      ...
      }, children !== null && children !== void 0 ? children : this.renderSelectedOptionText(this.getSelectedOption()));
    }
  }, {
    key: "renderSelectedOptionReadOnly",
    value: function renderSelectedOptionReadOnly() {
      var _this$props$children2 = this.props.children,
        children = _this$props$children2 === void 0 ? null : _this$props$children2;
      return /*#__PURE__*/_react.default.createElement("div", {
        ref: this.selectOption,
    ...
    value: function renderSelectedOption() {
      var _this$props = this.props,
        ...
        children = _this$props$children3 === void 0 ? null : _this$props$children3;
